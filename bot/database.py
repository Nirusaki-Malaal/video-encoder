...
ffmpeg = "-map 0:v -map 0:a? -map 0:s:0? -c:v libx265 -pix_fmt yuv420p -x265-params 'no-info=1' -crf 28 -vf 'drawtext=fontfile=font.ttf:fontsize=25:fontcolor=white:bordercolor=black@0.50:x=w-tw-10:y=10:box=1:boxcolor=black@0.5:boxborderw=6:text=FIERCENETWORK' -s 854x480 -preset medium -metadata title='Visit For More Movies [t.me/Fiercenetwork]'  -metadata:s:v title='Visit Website [Fiercenetwork] t.me/Fiercenetwork] - 480p - HEVC - 8bit'  -metadata:s:a title='[Visit t.me/Fiercenetwork] - AAC - 40k kbps' -metadata:s:s title='[Fiercenetwork Subs]' -c:a libopus -ab 64k -ac 2 -c:s copy"
